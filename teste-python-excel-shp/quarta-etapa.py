...
traducoes = {
    ...
    'SAN/SAUN' : 'Setor de Autarquias Norte ',
    'SAS/SAUS' : 'Setor de Autarquias Sul ',
    ...
    'SGAP' : 'Setor de Grandes Áreas Públicas SGAN  SGAS',
    ...
    'SGO/SGON' : 'Setor de Garagens Oficiais ou Setor de Gairagens e Oficinas Norte',
    ...
    'EPPR' : 'Estrada Parque Estrada Parque Paranoá',
