...
caminho_excel = '/home/david/autom/quadras/quadras.xlsx'

# Remover a coluna de geometria temporariamente para evitar erros
gdf_temp = gdf.copy()
del gdf_temp['geometry']

# Salvar o GeoDataFrame como um arquivo Excel usando o Pandas
