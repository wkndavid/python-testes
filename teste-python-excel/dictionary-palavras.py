lista_palavras = [
    ...
    'SH MEIRELES - RESIDENCIAL FAZENDA SANTA MARIA', 'SH CONTAGEM/RECANTO DOS NOBRES', 'SH CONTANGEM/SÃO JORGE', 
    'SH CONTAGEM/PARAÍSO', 'SCIA', 'SHCNW', 'SHIN', 'EXPANSAO URBANA SETOR OESTE', 'SHCES', 'SHVP - ETAPA 3 - CA. SAMAMBAIA', 
    'SHIS', 'BAIRRO CRIXÁ', 'SRIA II', 'SETOR CENTRAL', 'SHCSW', 'ALDEIAS DO CERRADO', 
    'SH OURO VERMELHO II - FASE I E II', 'SITIO DO GAMA', 'SETOR RESIDENCIAL NORTE A', 'SETOR RESIDENCIAL LESTE', 
    'SETOR A SUL', 'SETOR DE EXPANSAO ECONOMICA', 'SETOR P NORTE', 'SETOR B NORTE', 'SETOR DE INDUSTRIA', 
    'SETOR HABITACIONAL VICENTE PIRES/GLEBA 1/2/3', 'SETOR N NORTE', 'SETOR O NORTE', 'SETOR B SUL', 
    'SETOR G NORTE', 'SMAS', 'SETOR RESIDENCIAL OESTE VILA NOSSA SENHORA DE FATI', 
    'SH TORORO / PARQUE DO MIRANTE', 'SH TORORO - ESTÂNCIA DEL REY', 'SRIA I', 'SAI/O', 'QELC', 'RIACHO FUNDO II', 
    'SETOR M NORTE', 'SHTQ', 'SH ESTRADA DO SOL/RESIDENCIAL QUINTAS INTERLAGOS', 'SETOR LESTE', 'SETOR G SUL', 
    'SETOR C SUL', 'SETOR INDUSTRIAL BERNARDO SAYAO', 'SETOR H NORTE', 'SETOR J NORTE', 'SHIGS', 'SETOR D NORTE', 
    'SETOR INDUSTRIAL', 'SEPS', 'SCRS', 'VILA VICENTINA', 'SETOR TRADICIONAL', 'SIG', 'SETOR NORTE', 'SCLS', 
    'VILA METROPOLITANA', 'EXPANSAO DO SETOR O', 'SGAS', 'SH GRANDE COLORADO/VIVENDAS LAGO AZUL', 'SCRN', 'SETOR OESTE', 
    'SH BOA VISTA - IMPÉRIO DOS NOBRES', 'ADE OESTE', 'SH TORORÓ JARDIM ATLÂNTICO SUL', 'SETOR F SUL', 
    'SETOR HABITACIONAL ALTO DA BOA VISTA', 'SETOR QI', 'SOF SUL', 'SML', 'SETOR A NORTE', 
    'SETOR HABITACIONAL SOL NASCENTE', 'SDMC', 'SGAN', 'SCLN', 'SEPN', 'SETOR C NORTE', 'SHN', 
    'SETOR COMERCIAL CENTRAL', 'ADE POLO JK', 'SH JARDIM BOTÂNICO - ETAPA 2', 'SETOR DE AREAS ESPECIAIS NORTE 1 BURITIS II', 
    'SH SAO BARTOLOMEU/ QUINTAS DA ALVORADA', 'ADE', 'SIA', 'SETOR SUL', 'SETOR E SUL', 'SETOR D SUL', 
    'SETOR F NORTE', 'SETOR E NORTE', 'CENTRO METROPOLITANO', 'SRES', 'SHTN', 'SHCAO', 'VILA DNOCS', 'SHPB', 
    'SETOR R NORTE', 'SH BONSUCESSO', 'SCLRN', 'SHS', 'SH SAO BARTOLOMEU TRECHO 1', 'VILA SAO JOSE', 'VPLA', 
    'SETOR DE AREAS ISOLADAS', 'SAUS', 'BAIRRO VEREDAS', 'SETOR Q NORTE', 'SETOR L NORTE', 'Q CENTRAL SETOR HOTELEIRO', 
    'Q CENTRAL SETOR RESIDENCIAL', 'SETOR DE DESENVOLVIMENTO ECONOMICO', 'STRC', 'QELC VILA TECNOLOGICA', 'MSPW', 
    'CENTRO URBANO', 'SETOR ITAMARACA', 'Q CENTRAL SETOR ADMINISTRATIVO', 'Q CENTRAL SETOR ADMINISTRATIVO E CULTURAL', 
    'Q CENTRAL SETOR COMERCIAL', 'SHLS', 'SAFS', 'SGO', 'SETOR DE OFICINAS E PEQUENAS INDUSTRIAS', 'SMHN', 'SCES', 'SCEN', 
    'SRTVN', 'SAUN', 'SHCGN', 'SH ARAPOANGA ETAPA 3', 'SHBJ - ETAPA 4', 'SH BOA VISTA - SÍTIO VILA CÉLIA', 'SHA', 
    'EXPANSÃO DA VILA SÃO JOSÉ', 'SH ARAPOANGA - ETAPA 3', 'SETOR HABITACIONAL ARAPOANGA', 'SH TORORO - SANTA BARBARA', 
    'SHJK', 'URBITA', 'SETOR MEIRELES', 'SH BOA VISTA', 'SH MEIRELES - RESIDENCIAL FAZENDA SANTA MARIA'
]
